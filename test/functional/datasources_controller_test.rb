...
class DatasourcesControllerTest < ActionController::TestCase
  ...
  test "should create datasource" do
    assert_difference('Datasource.count') do
      post :create, datasource: { comments: @datasource.comments, description: @datasource.description, name: @datasource.name, website: @datasource.website }
    end
  ...
  test "should update datasource" do
    put :update, id: @datasource, datasource: { comments: @datasource.comments, description: @datasource.description, name: @datasource.name, website: @datasource.website }
    assert_redirected_to datasource_path(assigns(:datasource))
  end
